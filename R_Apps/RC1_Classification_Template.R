...
# B                          CREATE YOUR  LOGISTIC REGRESSION CLASSIFIER MODEL HERE
#Create your classifier here
# classifier = glm (formula= Purchased ~ .,
#                   family = binomial,
#                   data = training_set)

#C                Predicting the Test Set REsults /Probabilities
prob_pred = predict(classifier, type='response', newdata = test_set[-3]) # 3.kolonu kaldirdik
y_pred = ifelse(prob_pred>0.5, 1, 0) # yes 1, no 0
